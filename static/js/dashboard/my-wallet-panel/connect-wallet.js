...
//
// This module handles the **My Wallet → Connect wallet** functionality.
//
// Exported functions:
//
//    WalletWizard
...
import { sanitizeText, toggleElement } from "../../utils.js";
...
const excludeFields = new Set(config.EXCLUDE_FIELDS);
const excludeTypes  = new Set(config.EXCLUDE_TYPES);
 ...
 */
async function handleWalletLinkFormSubmission(event) {
    event.preventDefault();
